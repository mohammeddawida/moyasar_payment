...
class PayModel{
  ...
  String currency = "SAR";// 3 currency code iso alpha payment currency. (default: SAR);
  ...
  String? capturedAt; // datetime of authroized payment captured. (default: null)
  String? voidedAt; // datetime of voided. (default: null)
  String? description; // payment description
  String? invoiceId; // ID of the invoice this payment is for if one exists.(default: null)
  late String ip; // User IP
  late String callbackUrl; // page url in customer’s site for final redirection. (used for creditcard 3-D secure and form payment)
  ...
  late Object source; // source object defined the type of payment.
